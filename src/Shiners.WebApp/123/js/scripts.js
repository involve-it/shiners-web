...
*************************************************** **/
	...
	jQuery(window).ready(function () {
	    ...
	    if (jQuery("html").hasClass("chrome") && jQuery("body").hasClass("smoothscroll")) {
	        loadScript('/lib/smoothscroll.js', function () {
	            jQuery.smoothScroll();
	        });
	    }
		Init(false);
 ...
 **************************************************************** **/
	function _mixitup() {
		...
		if(_container.length > 0) {
			loadScript(plugin_path + 'mixitup/build/jquery.mixitup.min.js', function() {
 ...
 **************************************************************** **/
	function _misc() {
		...
		if(portfolio_isotope_container.length > 0) {
			loadScript(plugin_path + 'isotope/dist/isotope.pkgd.min.js', function() {
 ...
 **************************************************************** **/
	function _pickers() {
		...
		if(_container_1.length > 0) {
			loadScript(plugin_path + 'bootstrap-datepicker/dist/js/bootstrap-datepicker.min.js', function() {
				...
				if(jQuery().datepicker) {
					...
					_container_1.each(function() {
						...
						if(_lang != 'en' && _lang != '') { // load language file
							loadScript(plugin_path + 'bootstrap-datepicker/dist/js/locales/bootstrap-datepicker.'+_lang+'.min.js');
						}
		...
		if(_container_2.length > 0) {
		    loadScript(plugin_path + 'moment/min/moment-with-locales.min.js', function () {
		...
		if(_container_4.length > 0) {
			loadScript(plugin_path + 'spectrum/spectrum.js', function() {
 ...
 **************************************************************** **/
	function _editors() {
		...
		if(_container_1.length > 0) {
			...
			loadScript(plugin_path + 'summernote/dist/summernote.min.js', function() {
				...
				if(jQuery().summernote) {
					...
					_container_1.each(function() {
						...
						alert(_lang);
							loadScript(plugin_path + 'summernote/dist/lang/summernote-'+_lang+'.js');
						}
